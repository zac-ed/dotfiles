...
layouts = [
    MonadTall(
              border_focus   = colors['shock_pink'], 
...
widget_defaults = dict(
                       ...
                       fontsize    = 28,
                       padding     = 6,
                       foreground  = colors['baby_pink']
                      )


    ### Draw arrows on the bar!
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                right_arrow(colors['lavender'], colors['hot_pink']),
                ...
                widget.GroupBox(
                                    ...
                                    active                      = colors['baby_pink'], 
                                    this_current_screen_border  = colors['cream_white'], 
                                    inactive                    = colors['steely_grey'], 
                                    background                  = colors['lavender']
                               ),

                right_arrow(hot_pink, lavender),
                TextBox(
                                    ' 󰦄 ',
                                    fontsize        = 27,
                                    padding         = 2,
                                    foreground      = colors['cream_white'],
                                    background      = colors['hot_pink'],
                                    mouse_callbacks = {
                                                      'Button1': rofi_programs(lazy)
                                                      }
                        ),

                right_arrow(colors['eggplant'], colors['hot_pink']),
                ...
                right_arrow(colors['hot_pink'], colors['eggplant']),
            ...
            35, margin = 4, opacity = 0.7, border_color = colors['cream_white'], border_width = 2  # bar height, margin
        ),
    ),
]
