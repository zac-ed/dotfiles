...
keys = [
    ...
    Key(    ### This spawns the app launcher ###
        [mod], "r",
        lazy.spawn(
        'rofi drun -theme rosy -show-icons -show drun'
                  ), 
        desc="Rofi"
       ),
    Key(    ### This spawns the app launcher ###
        [mod], "space",
        lazy.spawn(
        'rofi -theme rosy -show-icons -show drun'
                  ), 
    ...
    Key(    ### This shows you which windows are in which workspace! ###
        [mod], "s",
        lazy.spawn(
        'rofi -theme rosy -show-icons -show window'
                  ), 
